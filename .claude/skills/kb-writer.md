...
Before creating or editing content, read `/reference/glossary.mdx` to understand existing terminology.

**When writing:**
- Use glossary terms exactly as defined for consistency
- If you introduce a new domain-specific term, add it to the glossary
- If you discover a glossary definition is incomplete or incorrect, update it
- Structure glossary entries alphabetically under letter headings (## A, ## B, etc.)

**Glossary entry format:**
```mdx
### Term name

Definition text that explains what the term means in the context of Narrative I/O.
