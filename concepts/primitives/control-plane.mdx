...
**Identity and permissions.** User authentication, organization membership, and access controls all live in the control plane. When you grant another organization access to your data, that permission is recorded and enforced by the control plane.

**Query compilation and dispatch.** When you write an NQL query, the control plane parses it, validates your permissions, optimizes the execution plan, and dispatches it to the appropriate [data plane(s)](/concepts/primitives/data-planes) for execution.
