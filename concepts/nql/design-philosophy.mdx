...
**Cross-organization permissions.** When querying data from multiple organizations, permissions must be checked before execution. Standard SQL has no concept of cross-organization access grants or field-level controls.
...
3. **Checks** your permissions against access grants and field-level controls
