...
<Update label="Week of January 19, 2026" tags={["Rosetta Stone", "AI", "Improvement"]}>
  ...
  [Learn more →](/knowledge-base/ui-documentation/my-data/rosetta-stone-normalized-datasets)
...
<Update label="Week of January 2, 2026" tags={["Integrations", "New Feature"]}>
  ...
  [Learn more →](/knowledge-base/how-to-guides/connectors/tiktok-connector/)
</Update>
...
<Update label="Week of December 9, 2025" tags={["Enterprise", "Security", "New Feature"]}>
  ...
  [Learn more →](/blog/enterprise-single-sign-on)
</Update>
...
<Update label="Week of December 2, 2025" tags={["Audience Studio", "New Feature"]}>
  ...
  [Learn more →](/products/audience-studio)
</Update>
