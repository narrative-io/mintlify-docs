...
<Steps>
  <Step title="Open the query editor">
    ...
    - **Results pane**: Displays a sample of query results after execution
  </Step>
  ...
  <Step title="Run the query">
    ...
    The results pane now shows your data in a table format. You can:
    - Scroll through rows and columns
    - Sort by clicking column headers
    - Resize columns as needed

    <Info>
    The results pane displays a sample of up to 1,000 rows from your query results. The full results are stored as a dataset in your data plane. See [Data Flow](/concepts/architecture/data-flow#how-you-view-query-results) to learn how query results are handled.
    </Info>
  </Step>
